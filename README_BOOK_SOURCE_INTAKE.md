# BOOK SOURCE INTAKE — 2026-09-10

This file is a persistent source ledger for newly supplied book material. It supplements `README.md` without replacing the existing master register.

## 12 — O ŻYCIU O RELACJACH

**Full title:** `O ŻYCIU O RELACJACH`

**Subtitle visible on supplied cover:** `O TYM, CO NAPRAWDĘ MA ZNACZENIE`

**Branding on cover:** `AM — RELATIONSHIP COACHING`

**Author:** `ANDRZEJ MIKULSKI`

**Type / positioning:** personal development / relationships / conscious living / training and development material, based strictly on the supplied source text.
...
>
> **NIE CZEKAJ, AŻ ŻYCIE SAMO SIĘ ZMIENI. ZACZNIJ OD SIEBIE.**
>
> Kup książkę.
...
A dedicated promotional visual for this title was supplied in the conversation. The cover visibly identifies the title and subtitle above.
